  ...
  return (
    <section>
      ...
      <div className="my-6 flex flex-col md:flex-row gap-6 justify-center items-center text-center  ">
        ...
        <img src="/avatar2.jpg" width={200} height={50} alt="avatar" className="rounded-full my-5 shadow-lg self-center blur-sm"/>
        ...
        <div className="bg-gray-800 p-4 rounded-lg  max-w-md flex flex-col">
          <img src="/avatar.jpg" width={200} height={50} alt="avatar" className="rounded-full my-5 shadow-lg self-center blur-sm"/>
