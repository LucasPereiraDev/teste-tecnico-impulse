  ...
  return (
    <div className="flex flex-col justify-center items-center text-white mt-20 my-6 px-6">
      ...
      <h2 className="text-center text-lg sm:text-xl mt-4 max-w-2xl ">
        ...
        os maiores investidores do mercado não querem que você saiba! 🏡💰
      </h2>
      <p className="text-sm sm:text-base text-center text-zinc-300 mt-3 ">
        As vagas são limitadas e já estão quase esgotadas. Não perca essa oportunidade única!
      </p>
     </div>
  );
}
